...
htable* newTable(int (*hashfunc)(void*), int (*equalsfunc)(void*,void*), void* (*clonekeyfunc)(void*), void* (*clonevaluefunc)(void*));//create HashTable
...
void remove(htable* hashtable,void* key);//remove from HashTable key-value pair
